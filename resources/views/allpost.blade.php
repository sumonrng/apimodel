                     ...
                     <tbody>
                        <tr>
                           <td>
                              <div class="d-flex align-items-center">
                                 <img class="rounded-pill img-fluid avatar-40 me-3 bg-soft-primary"
                        ...
                        <tr>
                           <td>
                              <div class="d-flex align-items-center">
                                 <img class="rounded-pill img-fluid avatar-40 me-3 bg-soft-primary"
                                    src="../../assets/images/avatars/02.png" alt="profile">
                        ...
                        <tr>
                           <td>
                              <div class="d-flex align-items-center">
                                 <img class="rounded-pill img-fluid avatar-40 me-3 bg-soft-primary"
                                    src="../../assets/images/avatars/03.png" alt="profile">
                        ...
                        <tr>
                           <td>
                              <div class="d-flex align-items-center">
                                 <img class="rounded-pill img-fluid avatar-40 me-3 bg-soft-primary"
                                    src="../../assets/images/avatars/04.png" alt="profile">
                        ...
                        <tr>
                           <td>
                              <div class="d-flex align-items-center">
                                 <img class="rounded-pill img-fluid avatar-40 me-3 bg-soft-primary"
                                    src="../../assets/images/avatars/05.png" alt="profile">

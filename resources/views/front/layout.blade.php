            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-contact iq-r4-mt-40">
                        <div class="heading-left">
                            <h5 class="title  text-white">Contact CoinEx</h5></div>
                        <div class="iq-mb-20">
                        ...
                        <div class="col-sm-6">
                            <div class="form-check">
                                <x-input-label class="form-check-label">
                                    <input type="checkbox" class="form-check-input">Remember Me</x-input-label>
                            </div>
                        </div>
...
<div class="modal fade iq-register" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <x-form action="{{ route('signup') }}" method="POST">
                    <div class="form-group mb-3">
                        <x-text-input type="text" name="sponsor_id"  id="sponsor_id" placeholder="Sponsor ID"/>
                    </div>
                    <div class="form-group mb-3">
                        <x-text-input type="text" name="user"  id="user" placeholder="User Name"/>
                    </div>
                    <div class="form-group mb-3">
                        <x-text-input type="text" name="fullName"  id="fullName" placeholder="Full Name"/>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        <x-text-input type="password" name="confirm-password" id="confirm-password" placeholder="Confirm Password"/>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" name="check" class="form-check-input">I Agree to the Terms and Conditions</label>
                    </div>
                    <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    <x-button type="submit" class="button iq-mtb-10 button-inner-box" :value="__('Sign Up')"/>
                </x-form>
            </div>
            <div class="modal-footer text-center">
...
Register -->
    ...
    <div class="iq-customizer closed">
        ...
        <div class="clearfix content-chooser">
            ...
            <a target="_blank" class="button" href="https://1.envato.market/MXNo22?u=https%3A%2F%2Fthemeforest.net%2Fcheckout%2Ffrom_item%2F21176834%3Flicense%3Dregular">Purchase Now</a>
        </div>
    </div>
